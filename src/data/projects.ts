...
management to enhance clinical efficiency and care quality.`,
  ...
  {
    id: "proj-6",
    slug: "brainlab-bd-ecommerce-platform",
    title: "BrainLab BD",
    description: "Complete e-commerce solution for the Bangladesh market.",
    ...
    role: "Full Stack Developer",
    duration: "2 months",
    liveUrl: "http://brainlabbd.com/", // CLI tools usually don't have live URLs
    githubUrl: "https://github.com/kawsar007",
    featured: false,
    highlights: [
  ...
  },
  {
    id: "proj-7",
    slug: "orbi-mili-tag",
    title: "Orbi Mili Tag — Smart IoT Device",
    description:
      "Full-stack Cash-on-Delivery storefront for the Bangladesh market with location-based delivery pricing, marketing attribution tracking, and an admin operations dashboard.",
    longDescription: `Designed and built a production-ready, single-product Cash-on-Delivery e-commerce platform end to end — a conversion-focused Next.js storefront, a MySQL-backed order pipeline with location-based delivery pricing, a full GA4/Meta Pixel marketing analytics system with first-party attribution tracking, and a JWT-authenticated admin panel for managing orders, pricing, and traffic reports.`,
    thumbnail: "/projects/orbi.png",
    images: ["/projects/pulse-pro-1.jpg", "/projects/pulse-pro-2.jpg"],
    technologies: [
      "Next.js 16",
      "React 19",
      "TypeScript",
    ...
    role: "Full Stack Developer",
    duration: "2 weeks",
    liveUrl: "https://www.orbigpstracker.com/mili-tag",
    githubUrl: "https://github.com/kawsar007",
    featured: false,
    highlights: [
      "Built a mobile-first, single-product COD storefront with Next.js App Router and a custom Tailwind v4 CSS-token design system, including a hand-built animated SVG hero illustration (pulse rings + equalizer) instead of stock imagery",
      "Designed a Prisma/MySQL schema spanning Product, Order, Admin, Visitor, Session, and AnalyticsEvent models, with all monetary values stored as integer paisa to eliminate floating-point rounding errors",
      "Implemented JWT-based admin authentication using edge-safe token verification (jose) in Next.js Middleware to protect the entire /admin route tree, with bcrypt password hashing and a self-service change-password endpoint enforcing an independent password policy",
      "Engineered a location-based delivery charge system (Inside Dhaka ৳80 / Outside Dhaka ৳120) that is always computed and validated server-side — never trusting client-submitted totals — while the checkout UI recalculates the product price, delivery fee, and grand total instantly on every change",
      "Built a full first-party marketing analytics pipeline: GA4 and Meta Pixel integration gated behind a cookie-consent banner, UTM/gclid/fbclid capture, first-touch visitor cookies, 30-minute session windows, and server-side traffic-source classification (Facebook, Instagram, Google Ads, Organic, Direct, Referral)",
      "Snapshotted complete attribution data (UTM parameters, click IDs, referrer, traffic source) onto every order for accurate marketing ROI reporting, deliberately decoupled from analytics cookie consent since it's tied to a transaction the customer initiated",
      "Designed an admin analytics dashboard with KPI cards, a sessions-vs-orders timeseries chart (Recharts), traffic-source and top-campaign breakdown tables, and adjustable date-range filters",
      "Built a Product management API using an upsert-by-slug pattern to guarantee a single canonical product record (never a duplicate), paired with a reusable `useProduct()` hook shared across the storefront checkout and the admin product editor",
      "Developed an admin orders panel with debounced search, status filtering, inline status updates, server-side pagination, and per-order detail views showing the full delivery and attribution breakdown",
      "Enforced strict runtime validation with Zod across every API boundary (orders, authentication, analytics, product updates), returning consistent field-level error responses consumed directly by the frontend forms",
    ],
  },
  {
    id: "proj-8",
  ...
  },
  {
    ...
    description:
      "A mobile app to log, track, and export professional trip reports with offline-first SQLite storage.",
    longDescription:
